      ...
      <br />  
           <div class="login-container">   
                ...
                <form method="post" autocomplete="off"> 
                    <input type="text" name="username" class="login-container__input" autocomplete="off" placeholder="Korisničko ime"/>  
                    <br/>
                    <input type="password" name="password" class="login-container__input" autocomplete="off" placeholder="Lozinka"/>  
                    <br/>  
                    <?php  
                        if(isset($message))  
                        {  
                    ...
                    <input type="submit" name="login" class="login-container__btn" value="Prijava" />  
                </form>  
           </div>  
           <br />  
      </body>  
